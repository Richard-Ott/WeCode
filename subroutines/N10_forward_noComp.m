function Ntot10 = N10_forward_noComp(pp,sp10,sf10,cp10,maxage,scaling_model,soil_mass,D,X)
% This functions computes the average soil 10Be concentration in a soil
...
% Ntot10 = N_SBI10 + P_avg10 * (soil_mass/(D/1000)) * (D/(D-W)); % no decay
Ntot10 = (N_SBI10 - P_avg10/pp.lambda10Be)*exp(-pp.lambda10Be * (soil_mass/(D/1000)) * (D/(D-W)))+ P_avg10/pp.lambda10Be;  
